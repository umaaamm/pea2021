		...
		<div class="article-card article-full no-bottom">
			<div class="article-header">
					...
					<?php 
							...
							echo "<span class='article-author color-white'><i class='fa fa-book opacity-50'></i>$row[2]</span>";
...
<?php
			if($id==99){
				$result=mysqli_query($koneksi, "SELECT * FROM tb_pevita_jadwal where event_id='$id' and event_kanwil='$kode_unit_kerja' and tgl='13' order by schedule_begin ASC");
				$row=mysqli_fetch_row($result);
...
<?php
			if($id==99){
				$result=mysqli_query($koneksi, "SELECT * FROM tb_pevita_jadwal where event_id='$id' and event_kanwil='$kode_unit_kerja' and tgl='14' order by schedule_begin ASC");
				$row=mysqli_fetch_row($result);
...
<?php
			if($id==99){
				$result=mysqli_query($koneksi, "SELECT * FROM tb_pevita_jadwal where event_id='$id' and event_kanwil='$kode_unit_kerja' and tgl='15' order by schedule_begin ASC");
				$row=mysqli_fetch_row($result);
