...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        addData = function(){
          ...
          $('#no_bagasi').prop('readonly', false);
          $('#keterangan').prop('readonly', false);
          $('#id_kontak').prop('readonly', false);
                ...
                success : function(response){
                    if(response.status == 'error'){
                      ...
                      //########## SET VALUE FORM EDIT (EDIT BELOW)##########//
                        ...
                        $('#no_bagasi').val(response.data.no_bagasi).prop('readonly', true);
                        $('#keterangan').val(response.data.keterangan).prop('readonly', true);
                        $('#id_kontak').val(response.data.id_kontak).prop('readonly', false);
            ...
            success : function(response){
                if(response.status == 'error'){
                  ...
                  //########## SET VALUE FORM VIEW (EDIT BELOW)##########//
                        ...
                        $('#no_bagasi').val(response.data.no_bagasi).prop('readonly', true);
                        $('#keterangan').val(response.data.keterangan).prop('readonly', true);
                        $('#id_kontak').val(response.data.id_kontak).prop('readonly', true);
                        $('#status').val(response.data.status).prop('readonly', true);
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="datatableList">
                                            ...
                                            <?php
                                              if ($tracking_list) {
                                                foreach ($tracking_list as $list) {
                                            ?>
                                                <tr>
                                                  <td><?php echo $list['nama_pegawai']; ?><br><b><?php echo $list['nik_pegawai']; ?><b></td>
                                                  <td><b><?php echo $list['no_bagasi']; ?></b><br><?php echo $list['keterangan_val']; ?><br><br>
                                                  <!-- <td></td> -->
                                                  <!-- <td><?php echo $list['keterangan']; ?></td> -->
                                                  <!-- <td><?php echo $list['nama']; ?></td>  -->
												  <!-- <td><?php echo $list['keterangan_val']; ?></td> -->
                                                  <!-- <td><?php echo $list['tgl_update']; ?></td> -->
                                
                                                  <!-- <td> -->
                                                      <?php if ($akses['is_view'] == 1) { ?>
                                                        <button type="button" class="btn blue btn-xs" onclick="viewData(<?php echo "'".$list['id_tracking']."'"; ?>)"><i class="fa fa-search"></i></button>
                                                      <?php } ?>
                                                      <?php if ($akses['is_edit'] == 1) { ?>
                                                        <button type="button" class="btn green btn-xs" onclick="editData(<?php echo "'".$list['id_tracking']."'"; ?>)"><i class="fa fa-edit"></i></button>
                                                      <?php } ?>
                                                      <?php if ($akses['is_delete'] == 1) { ?>
                                                        <button type="button" class="btn red btn-xs" onclick="deleteData(<?php echo "'".$list['id_tracking']."'"; ?>)"><i class="fa fa-trash"></i></button>
                                                      <?php } ?>
                                                  </td>
                                                </tr>
                                            <?php
                                    ...
                                    ?>
                                        <div class="modal-body">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-sm-2">No Bagasi <span class="required"> * </span></label>
                                                    <div class="col-sm-10">
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                            <input type="text" class="form-control" id="no_bagasi" name="no_bagasi">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                            <select class="form-control" name="id_kontak" id="id_kontak">
                                                                <option value="-">- Pilih Salah Satu -</option>
                                                                <?php 
                                                                foreach($kontak_list as $row):?>
                                                                    <option value="<?php echo $row->id_kontak;?>"><?php echo $row->nama;?> - <?php echo $row->bagian;?></option>
                                                                <?php endforeach;?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="input-icon right">
                                                            ...
                                                            <select class="form-control" name="status" id="status">
                                                                ...
                                                                foreach($status_list as $row):?>
                                                                    <option value="<?php echo $row->id_val;?>"><?php echo $row->keterangan_val;?></option>
                                                                <?php endforeach;?>                                                            
                                                            </select>
                                                        </div>
                                                    </div>
