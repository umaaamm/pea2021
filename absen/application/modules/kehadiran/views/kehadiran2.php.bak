...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        addData = function(){
          ...
          $('#event_id').prop('readonly', false);
          $('#nm_event').prop('readonly', false);
          $('#event_kanwil').prop('readonly', false);
          $('#nm_kantor').prop('readonly', false);
                ...
                success : function(response){
                    if(response.status == 'error'){
                      ...
                      //########## SET VALUE FORM EDIT (EDIT BELOW)##########//
                        ...
                        $('#event_id').val(response.data.event_id).prop('readonly', true);
                        $('#nm_event').val(response.data.nm_event).prop('readonly', false);
                        $('#event_kanwil').val(response.data.event_kanwil).prop('readonly', false);
                        $('#nm_kantor').val(response.data.nm_kantor).prop('readonly', false);
          ...
          $.ajax({
            ...
            success : function(response){
                if(response.status == 'error'){
                  ...
                  $('#nik').val(response.data.nik).prop('readonly', true);
                        $('#nama').val(response.data.nama).prop('readonly', true);
                        $('#nm_event').val(response.data.nm_event).prop('readonly', true);
                        $('#nm_kantor').val(response.data.nm_kantor).prop('readonly', true);
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="datatableList">
                                            ...
                                            ?>
                                                <tr>
                                                  ...
                                                  <td><?php echo $list['nm_event']; ?></td>
                                                  <td><?php echo $list['nm_kantor']; ?></td>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                            <input type="text" class="form-control" id="nm_event" name="nm_event">
                                                        </div>
                                                    </div>
                                                </div>
												...
												<div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                            <input type="text" class="form-control" id="nm_kantor" name="nm_kantor">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- <div class="form-group">
                                                    <label class="control-label col-sm-2">Rekening Tabungan Emas</label>
                                                    <div class="col-sm-10">
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-sm-2">Kredit GTE</label>
                                                    <div class="col-sm-10">
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
