		...
		<div id="page-content-scroll"><!--Enables this element to be scrolled -->
			...
			<div class="article-card article-full full-bottom">
				<div class="article-header">
					...
					echo "<span class='article-category color-white uppercase'>Selamat Datang, $namaku</span>";
					?>
			...
			<div class="content reading-time-box reading-words">
				...
				<div class="content">
					...
					echo '<div class=\'news-list-item2\'>';
						...
						$result=mysqli_query($koneksi, "SELECT * FROM pevita_event where event_date_end >= curdate() AND event_kanwil = $unit_kerja");
						...
						if(mysqli_num_rows($result) > 0) {
							...
							echo "<p><center>Maaf, saat ini tidak ada event untuk wilayah anda.</center></p>";
